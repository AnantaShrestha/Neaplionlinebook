...
@section('page_title','Sorting New Category')
@section('content')
<div class="row">
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <a style="float:right" href="{{route('admin.newscategoryDetails')}}" class="btn btn-warning">Go Back</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            	<div class="category-list">
            		<ul id="category-ul">
            			<input type="hidden" value="{{route('admin.sortNewscategoryUpdate')}}" class="url">

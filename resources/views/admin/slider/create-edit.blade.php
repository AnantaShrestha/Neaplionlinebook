        ...
        <div class="modal-body">
         ...
         <form method="post" id="submit_data" class="form-horizontal getformId" enctype="multipart/form-data">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
              <label class="control-label col-md-4">Image : (*) <span id="storeImage" style="display:inline-block"></span></label>
              <div class="col-md-12">
           ...
           <div class="form-group">
            ...
            <div class="form-group" >
              ...
              <input type="hidden" name="store_url" id="store_url" value="{{route('admin.sliderStore')}}" class="store_url">
              <input type="hidden" name="edit_url" value="{{route('admin.updateSlider')}}" class="edit_url" id="edit_url">
